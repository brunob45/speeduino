  ...
  switch (currentCommand)
  {
    ...
    */
    ...
    case 'Q': // send code version
      mySerial.print(F("speeduino 202003-dev"));
      break;
    ...
    case 'S': // send code version
      mySerial.print(F("Speeduino 2020.03-dev"));
...
void sendPageASCII(Stream& mySerial)
{
  ...
  switch (currentPage)
  {
    ...
    case veSetPage:
      ...
      for (pnt_configPage = (uint16_t *)&configPage2.injAng + 9; pnt_configPage < &configPage2.mapMax; pnt_configPage = (byte *)pnt_configPage + 1) { mySerial.println(*((byte *)pnt_configPage)); }

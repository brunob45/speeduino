...
void initialiseTriggers()
{
  ...
  if (configPage4.TrigPattern < sizeof(triggerSetup))
  {
    triggerSetup[configPage4.TrigPattern]();

    attachInterrupt(triggerInterrupt, triggerHandler, primaryTriggerEdge);
    if (decoderHasSecondary) { attachInterrupt(triggerInterrupt2, triggerSecondaryHandler, secondaryTriggerEdge); }
  }
}

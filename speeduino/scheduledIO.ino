...
#define TACH_PULSE_LOW() if( (configPage2.tachoDiv == 0) || tachoAlt ) { *tach_pin_port &= ~(tach_pin_mask); tachoAlt = !tachoAlt; }
  ...
  inline void beginCoil1Charge() { digitalWrite(pinCoil1, coilLOW); TACH_PULSE_LOW(); }
  inline void endCoil1Charge() { digitalWrite(pinCoil1, coilHIGH); TACH_PULSE_HIGH(); }

  inline void beginCoil2Charge() { digitalWrite(pinCoil2, coilLOW); TACH_PULSE_LOW(); }
  inline void endCoil2Charge() { digitalWrite(pinCoil2, coilHIGH); TACH_PULSE_HIGH(); }
...
void beginCoil1and3Charge() { digitalWrite(pinCoil1, coilLOW); digitalWrite(pinCoil3, coilHIGH); TACH_PULSE_LOW();  }
void endCoil1and3Charge()   { digitalWrite(pinCoil1, coilHIGH);  digitalWrite(pinCoil3, coilLOW);  TACH_PULSE_HIGH(); }
void beginCoil2and4Charge() { digitalWrite(pinCoil2, coilLOW); digitalWrite(pinCoil4, coilHIGH); TACH_PULSE_LOW();  }
void endCoil2and4Charge()   { digitalWrite(pinCoil2, coilHIGH);  digitalWrite(pinCoil4, coilLOW);  TACH_PULSE_HIGH(); }
